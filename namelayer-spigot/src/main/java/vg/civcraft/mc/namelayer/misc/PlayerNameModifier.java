 ...
 */
public final class PlayerNameModifier {
	 ...
	 */
	public PlayerNameModifier() throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException {
	 ...
	 */
	public boolean modify(final Player player) {
